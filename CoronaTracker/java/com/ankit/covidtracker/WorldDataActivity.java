...
public class WorldDataActivity extends AppCompatActivity {
    ...
    TextView tv_confirmed, tv_confirmed_new, tv_active, tv_active_new, tv_recovered, tv_recovered_new, tv_death, tv_death_new, tv_tests;
    SwipeRefreshLayout swipeRefreshLayout;
    String str_confirmed, str_confirmed_new, str_active, str_active_new, str_recovered, str_recovered_new, str_death, str_death_new, str_tests;
    LinearLayout lin_countrywise;
    private int int_active_new = 0;
    ProgressDialog progressDialog;
    PieChart pieChart;

    private MainActivity activity = new MainActivity(); // Here i have made the object of mainActivity so that we can use the methods of mainactivity here in onother activity.
